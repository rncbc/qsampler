...
#include "ui_qsamplerPaletteForm.h"
...
PaletteForm::PaletteForm ( QWidget *parent, const QPalette& pal )
	: QDialog(parent), p_ui(new Ui::qsamplerPaletteForm), m_ui(*p_ui)
{
	m_ui.setupUi(this);
...
void PaletteForm::setPalette ( const QPalette& pal )
{
	m_palette = pal;
...
void PaletteForm::setPalette ( const QPalette& pal, const QPalette& parentPal )
{
...
const QPalette& PaletteForm::palette (void) const
{
	return m_palette;
}


void PaletteForm::setSettings ( QSettings *settings, bool owner )
{
...
QSettings *PaletteForm::settings (void) const
{
	return m_settings;
}


void PaletteForm::nameComboChanged ( const QString& name )
{
...
void PaletteForm::saveButtonClicked (void)
{
...
void PaletteForm::deleteButtonClicked (void)
{
	const QString& name = m_ui.nameCombo->currentText();
...
void PaletteForm::generateButtonChanged (void)
{
	const QColor& color
...
void PaletteForm::resetButtonClicked (void)
{
...
void PaletteForm::detailsCheckClicked (void)
{
...
void PaletteForm::importButtonClicked (void)
{
	const QString& title
...
void PaletteForm::exportButtonClicked (void)
{
	const QString& title
...
void PaletteForm::paletteChanged ( const QPalette& pal )
{
	m_modelUpdated = true;
	if (!m_paletteUpdated)
		setPalette(pal);
...
void PaletteForm::setPaletteName ( const QString& name )
{
...
QString PaletteForm::paletteName (void) const
{
	return m_ui.nameCombo->currentText();
}


void PaletteForm::updateNamedPaletteList (void)
{
	const bool blocked = m_ui.nameCombo->blockSignals(true);
...
void PaletteForm::updateGenerateButton (void)
{
...
void PaletteForm::updateDialogButtons (void)
{
	const QString& name = m_ui.nameCombo->currentText();
...
bool PaletteForm::namedPalette ( const QString& name, QPalette& pal ) const
{
	return namedPalette(m_settings, name, pal);
}


bool PaletteForm::namedPalette (
...
QStringList PaletteForm::namedPaletteList (void) const
{
	return namedPaletteList(m_settings);
}


QStringList PaletteForm::namedPaletteList ( QSettings *settings )
{
	QStringList list;
...
QString PaletteForm::namedPaletteConf ( const QString& name ) const
{
	return namedPaletteConf(m_settings, name);
}


QString PaletteForm::namedPaletteConf (
...
void PaletteForm::addNamedPaletteConf (
...
void PaletteForm::deleteNamedPaletteConf ( const QString& name )
{
	if (m_settings) {
...
bool PaletteForm::loadNamedPaletteConf (
...
bool PaletteForm::saveNamedPaletteConf (
...
bool PaletteForm::loadNamedPalette (
...
bool PaletteForm::saveNamedPalette (
...
QPalette::ColorRole PaletteForm::colorRole ( const QString& name )
{
...
bool PaletteForm::isDirty (void) const
{
	return (m_dirtyTotal > 0);
}


void PaletteForm::accept (void)
{
...
void PaletteForm::setDefaultDir ( const QString& dir )
{
	if (m_settings) {
...
QString PaletteForm::defaultDir (void) const
{
	QString dir;
...
void PaletteForm::setShowDetails ( bool on )
{
	if (m_settings) {
		m_settings->beginGroup(PaletteEditorGroup);
...
bool PaletteForm::isShowDetails (void) const
{
	bool on = false;
...
void PaletteForm::showEvent ( QShowEvent *event )
{
...
void PaletteForm::resizeEvent ( QResizeEvent *event )
{
...
//-------------------------------------------------------------------------
// PaletteForm::PaletteModel

PaletteForm::PaletteModel::PaletteModel ( QObject *parent )
...
int PaletteForm::PaletteModel::rowCount ( const QModelIndex& ) const
{
	return m_nrows;
}


int PaletteForm::PaletteModel::columnCount ( const QModelIndex& ) const
{
	return 4;
}


QVariant PaletteForm::PaletteModel::data ( const QModelIndex& index, int role ) const
{
	if (!index.isValid())
		return QVariant();
...
bool PaletteForm::PaletteModel::setData (
...
Qt::ItemFlags PaletteForm::PaletteModel::flags ( const QModelIndex& index ) const
{
	if (!index.isValid())
...
QVariant PaletteForm::PaletteModel::headerData (
...
const QPalette& PaletteForm::PaletteModel::palette(void) const
{
	return m_palette;
}


void PaletteForm::PaletteModel::setPalette (
...
QPalette::ColorGroup PaletteForm::PaletteModel::columnToGroup ( int index ) const
{
	if (index == 1)
...
int PaletteForm::PaletteModel::groupToColumn ( QPalette::ColorGroup group ) const
{
...
//-------------------------------------------------------------------------
// QSampler::PaletteForm::ColorDelegate

QWidget *PaletteForm::ColorDelegate::createEditor ( QWidget *parent,
...
void PaletteForm::ColorDelegate::setEditorData (
...
void PaletteForm::ColorDelegate::setModelData ( QWidget *editor,
...
void PaletteForm::ColorDelegate::updateEditorGeometry ( QWidget *editor,
...
void PaletteForm::ColorDelegate::paint ( QPainter *painter,
	const QStyleOptionViewItem& option, const QModelIndex& index ) const
{
...
QSize PaletteForm::ColorDelegate::sizeHint (
	const QStyleOptionViewItem& option, const QModelIndex &index) const
{
...
//-------------------------------------------------------------------------
// QSampler::PaletteForm::ColorButton

PaletteForm::ColorButton::ColorButton ( QWidget *parent )
...
const QBrush& PaletteForm::ColorButton::brush (void) const
{
	return m_brush;
}


void PaletteForm::ColorButton::setBrush ( const QBrush& brush )
{
	m_brush = brush;
	update();
}
...
void PaletteForm::ColorButton::paintEvent ( QPaintEvent *event )
{
...
void PaletteForm::ColorButton::chooseColor (void)
{
	const QColor color
...
//-------------------------------------------------------------------------
// QSampler::PaletteForm::ColorEditor

PaletteForm::ColorEditor::ColorEditor ( QWidget *parent )
	: QWidget(parent)
{
	QLayout *layout = new QHBoxLayout(this);
	layout->setContentsMargins(0, 0, 0, 0);
	m_button = new PaletteForm::ColorButton(this);
...
void PaletteForm::ColorEditor::setColor ( const QColor& color )
{
...
QColor PaletteForm::ColorEditor::color (void) const
{
	return m_button->brush().color();
}


void PaletteForm::ColorEditor::colorChanged (void)
{
	m_changed = true;
	emit changed(this);
}
...
bool PaletteForm::ColorEditor::changed (void) const
{
	return m_changed;
}
...
//-------------------------------------------------------------------------
// QSampler::PaletteForm::RoleEditor

PaletteForm::RoleEditor::RoleEditor ( QWidget *parent )
	: QWidget(parent)
{
	m_edited = false;
...
void PaletteForm::RoleEditor::setLabel ( const QString& label )
{
	m_label->setText(label);
}


void PaletteForm::RoleEditor::setEdited ( bool on )
{
	QFont font;
	if (on)
		font.setBold(on);
...
bool PaletteForm::RoleEditor::edited (void) const
{
	return m_edited;
}


void PaletteForm::RoleEditor::resetProperty (void)
{
	setEdited(false);
	emit changed(this);
}
...
// end of qsamplerPaletteForm.cpp
