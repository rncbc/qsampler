...
bool PaletteForm::namedPalette ( const QString& name, QPalette& pal )
{
...
void PaletteForm::saveNamedPalette (
...
void PaletteForm::deleteNamedPalette ( const QString& name )
{
	if (m_settings) {
		m_settings->beginGroup(ColorThemesGroup);
...
QStringList PaletteForm::namedPaletteList (void)
{
